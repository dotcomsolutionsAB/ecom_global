                            ...
                            <div class="w-100">
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <!-- Product WA Keyword -->
                                        <div class="form-group row">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('WA Keyword')}}</label>
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="wa_keyword" value="{{ $product->wa_keyword }}" placeholder="{{ translate('WA Keyword') }}">
                                            </div>
                                        </div>
