<div class="text-left">
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            @if ($detailedProduct->digital == 0)
                ...
                @if ($detailedProduct->variation == 1 || true)
                <div class="text-secondary fs-14 fw-600 mt-2">Please Choose your suitable Product Options :- </div>
                @endIf
                    @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                        <div class="row no-gutters mb-3">
                            <div class="col-sm-2">
                                <div class="text-secondary fs-14 fw-800 mt-2 ">
            ...
            <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                ...
                <div class="col-sm-10">
                    <div class="product-price">
                        ...
                        </strong> (Incl. of all taxes)
						<br/>
						<strong id="price_excluding_tax" class="fs-15 fw-300 text-secondary">
    ...
    @else
        ...
        <a href="https://wa.me/+919123067443?text=Hi" class="wptwa-button wptwa-account wptwa-clearfix" data-number="919123067443" data-ga-label="ASMA INDUSTRIAL CORPORATION" target="_blank"><span class="wptwa-avatar"><svg class="WhatsApp" width="40px" height="40px" viewBox="0 0 92 92"><use xlink:href="#wptwa-logo"></use></svg></span><span class="wptwa-text"><span class="wptwa-profile">ASMA &nbsp;/&nbsp; Huzaifa Dhaman</span><span class="wptwa-copy">Need help? Chat via WhatsApp</span></span></a>
